    ...
    <div id="bienbanvp" class="container-fluid">
        ...
        <form class="">
            ...
            <div id="textboxVP" class="row mt-4">
                <div class="col">
                    <label class="" for=""> <b>Tên người
                            điều khiển xe</b></label>
            ...
            <div id="vipham_luatGT" class="row mt-4">
                <div class="col">
                        ...
                        <form id="form_searchVP" class="form-inline">
                            <input id="form_searchVP_input" class="form-control" type="search"
                                placeholder="Tìm tên vi
                                    phạm" aria-label="Search">
                            <button class="btn
                                    btn-outline-success" type="">Tìm</button>
                        </form>
                    </div>
                    ...
                    <div id="noidungVP" class="noidungVP">
                        <!-- tiêu đề -->
                        <div id="noidungVP_tieude" class="px-4 d-flex
                    ...
                    <div id="danhsachvipham">
                        ...
                        <div class="dsvipham_list my-2">
                            <span id="" class="ten_dsvipham_list">Vượt
                                đèn đỏ</span>
                            <button id="btn_xoaVP" type="button" class="bg-transparent
                                    border-0">
                                <span class="iconify" data-icon="akar-icons:circle-minus" style="color: #cc964a;
                                        font-size:20px;"></span>
                            </button>
                        </div>
                        <div class="dsvipham_list my-2">
            ...
            <div class="formBtn_submit my-2 d-flex justify-content-around">
                <a href = '{{ route('themvpTrang2')}}' type="button" class="btn formBtn_submit btn_chuyentrang text-white">Gây thiệt hại cho người</a>
